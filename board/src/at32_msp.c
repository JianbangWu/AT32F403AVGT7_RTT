...
#endif
#ifdef BSP_USING_UART3 // uart2_tx:pb10 uart2_rx:pb11
    if (USART3 == usart_x)
    {
...
#endif
#ifdef BSP_USING_UART4 // uart4_tx:pc10 uart4_rx:pc11
    if (USART3 == usart_x)
    {
...
#endif
#ifdef BSP_USING_UART5 // uart5_tx:pc12 uart5_rx:pd2
    if (USART3 == usart_x)
    {
...
#endif
#ifdef BSP_USING_UART8 // uart8_tx:pe1 uart8_rx:pe0
    if (USART3 == usart_x)
    {
...
void at32_msp_spi_init(void *instance)
{
    ...
    if (SPI1 == spi_x)
    {
        ...
        gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
        gpio_init_struct.gpio_pins = GPIO_PINS_5 | GPIO_PINS_7; // scl,mosi
        gpio_init(GPIOA, &gpio_init_struct);
    ...
    if (SPI2 == spi_x)
    {
        ...
        gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
        gpio_init_struct.gpio_pins = GPIO_PINS_13 | GPIO_PINS_15; // scl,mosi
        gpio_init(GPIOB, &gpio_init_struct);
...
#endif
#ifdef BSP_USING_SPI3 // mosi:pc12 sck:pc10  miso:pc11 SPI3_GMUX0001 SPI3_GMUX0011 均可
    if (SPI2 == spi_x)
    {
...
#endif
#ifdef BSP_USING_SPI4 // mosi:pe6 sck:pe2 miso:pe5
    if (SPI2 == spi_x)
    {
        ...
        gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
        gpio_init_struct.gpio_pins = GPIO_PINS_2 | GPIO_PINS_6; // scl,mosi
        gpio_init(GPIOE, &gpio_init_struct);

        // gpio_init_struct.gpio_mode = GPIO_MODE_INPUT;
        // gpio_init_struct.gpio_pins = GPIO_PINS_5; // miso
        // gpio_init(GPIOE, &gpio_init_struct);
    }
#endif
    /* add others */
...
void at32_msp_tmr_init(void *instance)
{
    ...
    if (tmr_x == TMR8)
    {
        ...
        gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
        gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
        gpio_init_struct.gpio_pins = GPIO_PINS_7; // TMR8_CH2:PC7 lcd_on_board dimming_pin
        gpio_init(GPIOC, &gpio_init_struct);
    }
    /* add others */
}
