...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t buf_1[MY_DISP_HOR_RES * 50];                             /*A buffer for 10 rows*/
    lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, NULL, MY_DISP_HOR_RES * 50); /*Initialize the display buffer*/
...
// extern void bsp_lcd_address_set(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2);
// extern struct rt_spi_device *spi_dev_st7796;
// #include "drv_spi.h"

#define DRV_DEBUG
#define LOG_TAG "lv_port_disp.c"
#include <drv_log.h>
...
static void disp_flush(lv_disp_drv_t *disp_drv, const lv_area_t *area, lv_color_t *color_p)
{
    if (disp_flush_enabled)
    {
        ...
        struct drv_lcd_config *lcd_device = lcd_handle;
